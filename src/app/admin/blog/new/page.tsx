...
import { ArrowLeft, Save, BookOpen, Layers, Star } from "lucide-react"
            ...
            <div className="flex items-center">
              ...
              <div className="flex flex-col ml-6">
                 ...
                 <p className="text-sm text-zinc-500 dark:text-zinc-400 font-medium">
                   Publish setups, tutorials, and guidelines.
                 </p>
              </div>
            </div>
          </div>
            ...
            <div className={cardClass}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
                <div className="md:col-span-2">
                  ...
                  <input name="title" required placeholder="e.g. Building Your First Custom Mechanical Keyboard" className={inputClass} />
                </div>

                <div>
                  <label className={labelClass}>Author Name</label>
                  <input name="author" defaultValue="E-Com Team" required className={inputClass} />
                </div>

                <div>
                  <label className={labelClass}>Status</label>
                  <div className="relative">
                    <select name="published" className={`${inputClass} appearance-none cursor-pointer`}>
                ...
                <div className="md:col-span-2">
                  ...
                  <input name="coverImage" placeholder="https://images.unsplash.com/... (optional)" className={inputClass} />
                </div>

                <div className="md:col-span-2">
                  <label className={labelClass}>Excerpt / Teaser Text</label>
                  <input name="excerpt" required placeholder="A short description of this article to entice readers..." className={inputClass} />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-end gap-4 pt-4">
              ...
              >
                ...
                <span className="relative flex items-center gap-2 px-8 py-3 rounded-[10px] bg-zinc-900 text-white font-bold transition-all group-hover:bg-zinc-800">
                   {loading ? "Saving..." : <><Save className="w-4 h-4" /> Save and Publish</>}
                </span>
              </button>
            </div>
